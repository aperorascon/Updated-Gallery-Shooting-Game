...
public class GalleryGameManager : MonoBehaviour
{
    ...
    private void OnRoomStateChanged(MapSchema<string> attributes)
    {
        ...
        if (attributes.ContainsKey("currentGameState"))
        {
            ...
            {
                Debug.LogError($"CurrentGameState: Failed to transition from {currentGameState} to {nextState}");
            }
        }
        ...
        if (attributes.ContainsKey("lastGameState"))
        {
            ...
            {
                Debug.LogError($"LastGameState: Failed to transition from {lastGameState} to {nextState}");
            }
        }
    }
