...
public class ExampleNetworkedEntityFactory
{
        ...
        Dictionary<string, object> attributes = null)
    {
        ...
        {
            Debug.LogError("No Prefab Declared");
            return;
        }
    ...
    {
        Debug.LogError($"Factory - Create From Prefab - {entity.id}");
        ...
        if (view == null)
        {
            Debug.LogError("Instantiated Object is not of ExampleNetworkedEntityView Type");
            asyncItem = null;
            return;
        }
    ...
    public void RegisterNetworkedEntityView(ExampleNetworkedEntity model, ColyseusNetworkedEntityView view)
    {
        ...
        {
            Debug.LogError("Cannot Find Entity in Room");
            return;
        }
